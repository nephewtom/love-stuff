-- From: http://rarlindseysmash.com/posts/sprite-love
AnimatedSprite = {}
...
function AnimatedSprite:create(file, width, height, frames, animations)
   ...
   setmetatable(object, AnimatedSprite) -- metatable?
...
function AnimatedSprite:load()
   ...
   for i = 1, self.animations do
      ...
      for j = 1, self.frames do
         ...
         self.sprites[i][j] = love.graphics.newQuad(w, h, self.width, self.height,
...
function AnimatedSprite:draw(x, y, sx, sy)
   love.graphics.draw(self.sprite_sheet, self.sprites[self.current_animation][self.current_frame], x, y, 0, sx, sy)
end
